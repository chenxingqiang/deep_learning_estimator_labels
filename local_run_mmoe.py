...
class ModelParams:
    def __init__(self):
        ...
        self.experts_units = int(sys.argv[14])
        self.experts_num = int(sys.argv[15])
        self.label1_weight = float(sys.argv[16])
        self.label2_weight = float(sys.argv[17])
